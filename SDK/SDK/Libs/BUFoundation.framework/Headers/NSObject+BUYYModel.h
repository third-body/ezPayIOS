 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `BUYYModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     [at]interface BUYYAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation BUYYAuthor
     @end
 
     [at]interface BUYYBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) BUYYAuthor *author;
     @end
     @implementation BUYYBook
     @end
    
     int main() {
         // create model from json
         BUYYBook *book = [BUYYBook BUYY_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book BUYY_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     [at]interface BUYYShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation BUYYShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self BUYY_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self BUYY_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self BUYY_modelCopy]; }
     - (NSUInteger)hash { return [self BUYY_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self BUYY_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (BUYYModel)
 ...
 */
+ (nullable instancetype)BUYY_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "BUYYBUYY-MM-dd'T'HH:mm:ssZ", "BUYYBUYY-MM-dd HH:mm:ss" or "BUYYBUYY-MM-dd".
     `NSString` -> NSURL.
     `NSValue` -> struct or union, such as CGRect, CGSize, ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)BUYY_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)BUYY_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)BUYY_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)BUYY_modelToJSONObject;
 ...
 */
- (nullable NSData *)BUYY_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)BUYY_modelToJSONString;
 ...
 */
- (void)BUYY_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)BUYY_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)BUYY_modelIsEqual:(id)model;
 ...
 */
- (NSString *)BUYY_modelDescription;
 ...
 */
+ (nullable NSArray *)BUYY_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (BUYYModel)
 ...
 */
+ (nullable NSDictionary *)BUYY_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<BUYYModel>' to your class header.
 */
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        [at]class BUYYShadow, BUYYBorder, BUYYAttachment;
 
        [at]interface BUYYAttributes
        @property NSString *name;
        ...
        @implementation BUYYAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [BUYYShadow class],
                     @"borders" : BUYYBorder.class,
                     @"attachments" : @"BUYYAttachment" };
        }
        @end
...
/**
 ...
 Example:
        [at]class BUYYCircle, BUYYRectangle, BUYYLine;
 
        @implementation BUYYShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [BUYYCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [BUYYRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [BUYYLine class];
            } else {
                return [self class];
            }
        }
